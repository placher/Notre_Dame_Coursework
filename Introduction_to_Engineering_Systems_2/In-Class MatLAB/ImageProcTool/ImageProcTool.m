...
% Last Modified by GUIDE v2.5 01-Apr-2015 21:29:29
...
myVal = handles.thresholdSlider.Value;

%set current value of edit box
myString = num2str(myVal);
handles.thresholdText.String = myString;
procImage(handles)
...
myString = handles.thresholdText.String;
%convert string to a number
myVal = str2double(myString);

%set the value of the slider
handles.thresholdSlider.Value = myVal;
procImage(handles)
...
%get current value of edit box
myString = handles.widthText.String;
%convert string to a number
myVal = str2double(myString);

%set the value of the slider
handles.widthSlider.Value = myVal;
procImage(handles)
...
%get current value of slider
myVal = handles.widthSlider.Value;

%set current value of edit box
myString = num2str(myVal);
handles.widthText.String = myString;
procImage(handles)
