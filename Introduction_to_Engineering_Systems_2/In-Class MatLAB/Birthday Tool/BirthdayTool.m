...
% Last Modified by GUIDE v2.5 04-Mar-2015 15:24:14
...
function NmaxEdit_Callback(hObject, eventdata, handles)
% hObject    handle to NmaxEdit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of NmaxEdit as text
%        str2double(get(hObject,'String')) returns contents of NmaxEdit as a double


% --- Executes during object creation, after setting all properties.
function NmaxEdit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to NmaxEdit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
...
function NsamplesEdit_Callback(hObject, eventdata, handles)
% hObject    handle to NsamplesEdit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of NsamplesEdit as text
%        str2double(get(hObject,'String')) returns contents of NsamplesEdit as a double


% --- Executes during object creation, after setting all properties.
function NsamplesEdit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to NsamplesEdit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
